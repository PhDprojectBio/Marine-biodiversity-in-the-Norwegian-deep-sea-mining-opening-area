...
library(readr)
alltseries_1876_1900_sjs <- read_delim("alltseries_1876_1900_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1876_1900_sjd <- read_delim("alltseries_1876_1900_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1900_1910_sjs <- read_delim("alltseries_1900_1910_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1900_1910_sjd <- read_delim("alltseries_1900_1910_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1910_1920_sjs <- read_delim("alltseries_1910_1920_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1910_1920_sjd <- read_delim("alltseries_1910_1920_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1920_1930_sjs <- read_delim("alltseries_1920_1930_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1920_1930_sjd <- read_delim("alltseries_1920_1930_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1930_1940_sjs <- read_delim("alltseries_1930_1940_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1930_1940_sjd <- read_delim("alltseries_1930_1940_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1940_1950_sjs <- read_delim("alltseries_1940_1950_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1940_1950_sjd <- read_delim("alltseries_1940_1950_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1950_1960_sjs <- read_delim("alltseries_1950_1960_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1950_1960_sjd <- read_delim("alltseries_1950_1960_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1960_1970_sjs <- read_delim("alltseries_1960_1970_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1960_1970_sjd <- read_delim("alltseries_1960_1970_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1970_1980_sjs <- read_delim("alltseries_1970_1980_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1970_1980_sjd <- read_delim("alltseries_1970_1980_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1980_1990_sjs <- read_delim("alltseries_1980_1990_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1980_1990_sjd <- read_delim("alltseries_1980_1990_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1990_2000_sjs <- read_delim("alltseries_1990_2000_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_1990_2000_sjd <- read_delim("alltseries_1990_2000_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_2000_2010_sjs <- read_delim("alltseries_2000_2010_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_2000_2010_sjd <- read_delim("alltseries_2000_2010_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_2010_2020_sjs <- read_delim("alltseries_2010_2020_sjs.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)

alltseries_2010_2020_sjd <- read_delim("alltseries_2010_2020_sjd.csv", 
                                            delim = ",", escape_double = FALSE, trim_ws = TRUE)
...
labels <- gsub("alltseries_", "", namesLog)
...
library(readr)
deep_1876_1900_sjdp <- read_delim("deep_1876_1900_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1876_1900_sjdb <- read_delim("deep_1876_1900_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1900_1910_sjdp <- read_delim("deep_1900_1910_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1900_1910_sjdb <- read_delim("deep_1900_1910_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1910_1920_sjdp <- read_delim("deep_1910_1920_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1910_1920_sjdb <- read_delim("deep_1910_1920_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1920_1930_sjdp <- read_delim("deep_1920_1930_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1920_1930_sjdb <- read_delim("deep_1920_1930_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1930_1940_sjdp <- read_delim("deep_1930_1940_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1930_1940_sjdb <- read_delim("deep_1930_1940_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1940_1950_sjdp <- read_delim("deep_1940_1950_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1940_1950_sjdb <- read_delim("deep_1940_1950_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1950_1960_sjdp <- read_delim("deep_1950_1960_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1950_1960_sjdb <- read_delim("deep_1950_1960_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1960_1970_sjdp <- read_delim("deep_1960_1970_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1960_1970_sjdb <- read_delim("deep_1960_1970_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1970_1980_sjdp <- read_delim("deep_1970_1980_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1970_1980_sjdb <- read_delim("deep_1970_1980_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1980_1990_sjdp <- read_delim("deep_1980_1990_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1980_1990_sjdb <- read_delim("deep_1980_1990_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1990_2000_sjdp <- read_delim("deep_1990_2000_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_1990_2000_sjdb <- read_delim("deep_1990_2000_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_2000_2010_sjdp <- read_delim("deep_2000_2010_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_2000_2010_sjdb <- read_delim("deep_2000_2010_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_2010_2020_sjdp <- read_delim("deep_2010_2020_sjdp.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)

deep_2010_2020_sjdb <- read_delim("deep_2010_2020_sjdb.csv", 
                                  delim = ",", escape_double = FALSE, trim_ws = TRUE)
...
namesLogPlankton <- gsub("alltseries_", "deep_", namesLogPlankton)
namesLogBenthos <- gsub("alltseries_", "deep_", namesLogBenthos)
...
library(readr) 
shallow_1876_1900_sjsp <- read_delim("shallow_1876_1900_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1876_1900_sjsb <- read_delim("shallow_1876_1900_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1900_1910_sjsp <- read_delim("shallow_1900_1910_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1900_1910_sjsb <- read_delim("shallow_1900_1910_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1910_1920_sjsp <- read_delim("shallow_1910_1920_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1910_1920_sjsb <- read_delim("shallow_1910_1920_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1920_1930_sjsp <- read_delim("shallow_1920_1930_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1920_1930_sjsb <- read_delim("shallow_1920_1930_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1930_1940_sjsp <- read_delim("shallow_1930_1940_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1930_1940_sjsb <- read_delim("shallow_1930_1940_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1940_1950_sjsp <- read_delim("shallow_1940_1950_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1940_1950_sjsb <- read_delim("shallow_1940_1950_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1950_1960_sjsp <- read_delim("shallow_1950_1960_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1950_1960_sjsb <- read_delim("shallow_1950_1960_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1960_1970_sjsp <- read_delim("shallow_1960_1970_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1960_1970_sjsb <- read_delim("shallow_1960_1970_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1970_1980_sjsp <- read_delim("shallow_1970_1980_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1970_1980_sjsb <- read_delim("shallow_1970_1980_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1980_1990_sjsp <- read_delim("shallow_1980_1990_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1980_1990_sjsb <- read_delim("shallow_1980_1990_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1990_2000_sjsp <- read_delim("shallow_1990_2000_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_1990_2000_sjsb <- read_delim("shallow_1990_2000_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_2000_2010_sjsp <- read_delim("shallow_2000_2010_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_2000_2010_sjsb <- read_delim("shallow_2000_2010_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_2010_2020_sjsp <- read_delim("shallow_2010_2020_sjsp.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)

shallow_2010_2020_sjsb <- read_delim("shallow_2010_2020_sjsb.csv", 
                                     delim = ",", escape_double = FALSE, trim_ws = TRUE)
