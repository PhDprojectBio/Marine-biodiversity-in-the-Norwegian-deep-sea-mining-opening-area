# Marine biodiversity in the Norwegian deep-sea mining opening area

This code has been developed and tested collaboratively with the authors of the paper ***Open-source marine biodiversity data quality in the Norwegian Sea spanning 149 years: knowledge gaps in the deep-sea mining opening area.***
...
Electronic source datasets were retrieved from these databases. Datasets analyzed are property of the respective data publishers and contributors. The specific download generated for this data mining analysis is available in the: 
